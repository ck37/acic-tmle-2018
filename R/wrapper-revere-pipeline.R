...
wrapper_revere_pipeline =
  function(data,
    ...
    pipeline_glm <- make_learner(Pipeline, screen_glmnet, lrnr_glm)
    pipeline_xgboost <- make_learner(Pipeline, screen_glmnet, lrnr_xgboost)
    pipeline_bartMachine <- make_learner(Pipeline, screen_glmnet, lrnr_bartMachine)
    pipeline_dbarts <- make_learner(Pipeline, screen_glmnet, lrnr_dbarts)
    pipeline_grf <- make_learner(Pipeline, screen_glmnet, lrnr_grf)
